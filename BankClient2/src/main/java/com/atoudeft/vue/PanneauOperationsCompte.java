...
public class PanneauOperationsCompte extends JPanel {
    ...
    public PanneauOperationsCompte() {
        ...
        /** pourquoi depot deux fois? en commentaire until i get confirmation from teacher**/
    ...
    public void setLblSolde(String solde) {
        if(solde.split(" ").length==3){this.lblSolde.setText("Solde : "+solde.split(" ")[2]+" $");}
        else if(solde.split(" ").length==2){this.lblSolde.setText("Solde : "+solde.split(" ")[1]+" $");}
    }
}
