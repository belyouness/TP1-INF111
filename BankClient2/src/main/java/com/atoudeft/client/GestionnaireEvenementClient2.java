...
//                    break;
                ...
                case "CONNECT":
                    ...
                    if (arg.trim().startsWith("NO")) {
                        ...
                        /** Q1 1.1 ajout pour eviter de rester bloquer et devoir appeller deconnection alors que il n'y a pas de connexion**/
                        client.deconnecter();
                        /** Q1 1.1 **/
                    }
                    else {
                ...
                case "EPARGNE" :
                    arg = evenement.getArgument();
                    if (arg.trim().startsWith("NO")) {
                        JOptionPane.showMessageDialog(panneauPrincipal, "Creation Epargne Refusee");
                    }
                    else {
                        str = arg.substring(arg.indexOf("OK")+2).trim();
                        panneauPrincipal.ajouterCompte(str);
                ...
                case "SELECT" :
                    ...
                    if(!arg.trim().startsWith("NO")){
                    panneauPrincipal.labelSolde(arg);}
                    break;
                ...
                case "DEPOT" :
                    ...
                    if(!arg.trim().startsWith("NO")){panneauPrincipal.labelSolde(arg);}
                    break;
                case "RETRAIT" :
                    arg = evenement.getArgument();
